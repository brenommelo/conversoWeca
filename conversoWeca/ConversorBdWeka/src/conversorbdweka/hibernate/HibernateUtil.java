package conversorbdweka.hibernate;

import conversorbdweka.utilidades.CustomLogger;
import java.io.File;
...
public class HibernateUtil {
    ...
    static {
        ...
        if (!file.exists()) {
//            CustomLogger.getLogger(HibernateUtil.class).error("Arquivo de configura��o n�o encontrado" + file.getAbsoluteFile(), new Exception("erro ao inicializar"));
            cfg.configure();
        } else {
