...
public class Usuario extends PojoBase implements Serializable {
    ...
    @Transient
    private boolean ativo; // responsável por setar selectBooleanCheckbox do view Cadastro de Usuario

    @Transient
    private boolean transf; // reponsavel por controlar se o usuario cadastrado no diagnostico esta ou não na tabela de usuario do TeleTransferencia
